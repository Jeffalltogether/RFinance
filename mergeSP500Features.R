mergeSP500Features <- function(SP500Classes, StockOverUnder, StockPrevRSIs, StockPrevRets, StockPrevSMAs){
  
  stockFeaturesDF <- data.frame(SP500Classes[8:length(SP500Classes)], SP500OverUnder[8:(nrow(SP500OverUnder)-2),], SP500PrevRSIs, SP500PrevRets, SP500PrevSMAs)
  stockFeaturesDF = rename(stockFeaturesDF, 
                           c("SP500Classes.8.length.SP500Classes.."="weeklyClass",              "prev1DaysRSI.8.length.prev1DaysRSI.."="prev1DaysRSI",           
