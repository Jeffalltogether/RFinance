mergeJunkBFeatures <- function(JunkBClasses, JunkBOverUnder, JunkBPrevRSIs, JunkBPrevRets, JunkBPrevSMAs){
  
  stockFeaturesDF <- data.frame(JunkBClasses[8:length(JunkBClasses)], JunkBOverUnder[8:(nrow(JunkBOverUnder)-2),], JunkBPrevRSIs, JunkBPrevRets, JunkBPrevSMAs)
  stockFeaturesDF = rename(stockFeaturesDF, 
                           c("JunkBClasses.8.length.JunkBClasses.."="weeklyClass",              "prev1DaysRSI.8.length.prev1DaysRSI.."="prev1DaysRSI",           
